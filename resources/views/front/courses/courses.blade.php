            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item">
                        ...
                        <p>{{trans('messages.Home')}}<span>/</span>{{trans('messages.Courses')}}</p>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5">
                <div class="section_tittle text-center">
                    <p>{{json_decode($diffrentCources->content)->subtitle}}</p>
                    <h2>{{json_decode($diffrentCources->content)->desc}}</h2>
                </div>
            </div>
        </div>
        <div class="row">
